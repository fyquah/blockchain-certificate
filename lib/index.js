...
module.exports.start = function(options){
    ...
    exec(__dirname + "/../node_modules/.bin/sequelize db:migrate --config $HOME/.blockchain-certificate/database.json --migrations-path " + __dirname + "/migrations --models-path " + __dirname + "/models", function(err){
        if(err) throw err;
