        ...
        Q.promise(function(resolve, reject, notify){
            models.Node.find_by({
                ...
                if (err !== null) {
                    ...
                    reject({
                        "message": "node with given metadata not found not found! This is another way of saying false",
            ...
            return Q.promise(function(resolve, reject, notify){
                models.User.find_by({
                    ...
                    if(err !== null) {
                        ...
                        reject({
                            "message": "user with given address not found! This is another way of saying false",
...
var create_bitcoin_transaction = function(rights_output, receipients, values, cb){
    bitcoind("getnewaddress", function(err, change_address){
        ...
        bitcoind("listunspent 0", function(err, unspent_inputs){
            ...
            console.log("the transaction before signing : ");
            console.log(tx);
