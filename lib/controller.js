...
var verify_rights_input = function(rights_input, cb){ // returns node if successful
    ...
    models.User.find_by({
        ...
        if(this !== null) {
            var signature = new Signature({
                ...
                "node_id": node.id,
                "type": type,
                "data": instruction.metadata.toString("hex")
            })
...
var execute = function(instruction, cb) {
    ...
    Q.promise(function(resolve, reject){
        if(instruction.op_code === constants.OP_INITIALIZE) {
            ...
            verify_rights_input(instruction.rights_input, function(err, node, rights){
                resolve(node, rights);
            });
        }
        ...
        return Q.promise(function(resolve, reject){
            var obj;
            if(instruction.op_code !== constants.OP_INITIALIZE && node === null) {
