            ...
            Q.promise(function(resolve, reject, notify){
                ...
                return Q.promise(function(resolve, reject, notify){
                    ...
                    if(current_config_json["block_count"] > current_block_count) {
                        ...
                        exec("bitcoind getblockhash " + current_config_json["block_count"], function(err, res){
                            if (err !== null) {
                                reject(err);
                                return;
                            }
                ...
                return Q.promise(function(resolve, reject, notify){
                    exec("bitcoind getblock " + block_hash, function(err, stdout){
                        if (err !== null) {
                            reject(err);
                            return;
                        }
                ...
                return Q.promise(function(resolve, reject, notify){
                    ...
                    process.nextTick(function process_txid(){
                        ...
                        exec("bitcoind getrawtransaction " + txid + " 1", function(err, stdout, stderr){
                            if (err !== null) {
