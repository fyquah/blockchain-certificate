...
var append_method = (function(){
    ...
    events.on("ready", function(){
        console.log("executing ready event");
        if(events_queue.length === 0) return;
        console.log("event_on_going = true");
        event_on_going = true;
        ...
        var cb = obj.cb;
        console.log(obj);
        console.log("EOFEOFEOFEOFEOFEOFEOFEOFEOFEOF")
        controller[type](args, function(err, res){
            ...
            console.log("event_on_going = false");
            events.emit("ready");
        });
    });
    ...
    return function(obj, type, method_name, arr){
        obj[method_name] = function(){
            ...
            if(args.auth_token === _auth_token) {
                console.log("pushing event into events queue");
                console.log(args);
                console.log("EOFEOFEOFEOFEOFEOFEOFEOFEOFEOF")
                events_queue.push({
                    args: args,
